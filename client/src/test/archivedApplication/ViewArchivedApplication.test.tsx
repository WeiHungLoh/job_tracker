...
describe('Archived job application viewing flow', () => {
    ...
    test('deletes application after user confirms', async () => {
        ...
        await waitFor(() => expect(fetch).toHaveBeenCalledWith(
            `${import.meta.env.VITE_API_URL}/archived-job-applications/1`, {
            method: 'DELETE',
            credentials: 'include'
        }
        ))
    ...
    test('unarchive job application', async () => {
        ...
        await waitFor(() => expect(fetch).toHaveBeenCalledWith(`${import.meta.env.VITE_API_URL}/archived-job-applications/1/restore`,
            {
                method: 'POST',
                credentials: 'include',
            }
