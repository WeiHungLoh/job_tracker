...
const ViewArchivedApplication = () => {
    const { data: archivedApplications, refetch } = useFetchData(`${process.env.REACT_APP_API_URL}/archived-job-applications`)
    ...
    const handleDelete = async (archivedApplicationId) => {
        try {
            ...
            if (confirmed) {
                await fetch(`${process.env.REACT_APP_API_URL}/archived-job-applications/delete/${archivedApplicationId}`, {
                    method: 'DELETE',
                    credentials: 'include'
                })
            }
    ...
    const handleDeleteAll = async () => {
        try {
            ...
            if (confirmed) {
                await fetch(`${process.env.REACT_APP_API_URL}/archived-job-applications`,
                    {
                        method: 'DELETE',
                        credentials: 'include'
                    }
    ...
    const handleUnarchive = async (archivedJobId) => {
        try {
            await fetch(`${process.env.REACT_APP_API_URL}/archived-job-applications/unarchived/${archivedJobId}`,
                {
                    method: 'DELETE',
                    credentials: 'include',
