...
const ViewArchivedInterview = () => {
    const { data: archivedInterviews, refetch } = useFetchData(`${process.env.REACT_APP_API_URL}/archived-job-interviews`)
    ...
    const handleDelete = async (interviewId) => {
        try {
            ...
            if (confirmed) {
                await fetch(`${process.env.REACT_APP_API_URL}/archived-job-interviews/${interviewId}`, {
                    method: 'DELETE',
                    credentials: 'include'
                })
            }
    ...
    const handleDeleteAll = async () => {
        try {
            ...
            if (confirmed) {
                await fetch(`${process.env.REACT_APP_API_URL}/archived-job-interviews`,
                    {
                        method: 'DELETE',
                        credentials: 'include'
                    }
