...
describe('Archived job application viewing flow', () => {
    ...
    test('deletes application after user confirms', async () => {
        ...
        await waitFor(() => expect(fetch).toHaveBeenCalledWith(
            `${process.env.REACT_APP_API_URL}/archived-job-applications/delete/1`, {
            method: 'DELETE',
            credentials: 'include'
        }
        ))
    ...
    test('deletes all archived applications after user confirms', async () => {
        ...
        await waitFor(() => expect(fetch).toHaveBeenCalledWith(
            `${process.env.REACT_APP_API_URL}/archived-job-applications`,
            {
                method: 'DELETE',
                credentials: 'include'
            }
    ...
    test('unarchive job application', async () => {
        ...
        await waitFor(() => expect(fetch).toHaveBeenCalledWith(`${process.env.REACT_APP_API_URL}/archived-job-applications/unarchived/1`,
            {
                method: 'DELETE',
                credentials: 'include',
