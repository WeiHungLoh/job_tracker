    ...
    return (
        <div className={styles.signin}>
            ...
            <div className={styles.noticeWrapper}>
                ...
                {'  '}If the sign-in process seems to hang after you click the sign in button, please wait at least 50
                seconds. This may happen because the backend is hosted on a free tier, which can take time to wake up
                after periods of inactivity.
            </div>
            <Link className={styles.ugLink} to={routes.userGuide} target='_blank'>
