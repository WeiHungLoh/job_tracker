...
const ViewInterview = () => {
    ...
    const { data: interviews, refetch } = useFetchData(`${process.env.REACT_APP_API_URL}/job-interviews`)
    ...
    const handleDelete = async (interviewId) => {
        try {
            ...
            if (confirmed) {
                await fetch(`${process.env.REACT_APP_API_URL}/job-interviews/${interviewId}`, {
                    method: 'DELETE',
                    credentials: 'include'
                })
            }
    ...
    const handleDeleteAll = async () => {
        try {
            ...
            if (confirmed) {
                await fetch(`${process.env.REACT_APP_API_URL}/job-interviews`,
                    {
                        method: 'DELETE',
                        credentials: 'include'
                    }
